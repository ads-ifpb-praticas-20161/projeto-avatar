...
import com.mycompany.contrloedeestoque.facade.CategoriaFacade;
...
public class CategoriaController implements Serializable {
    ...
    public String create() {
        try {
            ...
            JsfUtil.addErrorMessage(e,"Erro ao tentar persistir a Categoria");
            return null;
        }
    }
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage("Categoria atulizada com êxito!");
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, "Erro ao tentar atualizar a Categoria");
            return null;
        }
    }
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage("Categoria Deletada");
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, "Erro a o deletar categoria");
        }
    }
