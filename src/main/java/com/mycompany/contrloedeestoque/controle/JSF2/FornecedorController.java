...
import com.mycompany.contrloedeestoque.facade.FornecedorFacade;
...
public class FornecedorController implements Serializable {
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage("Fornecedor criado com sucesso!");
            return prepareCreate();
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, "Erro ao tentar persistir o Fornecedor");
            return null;
        }
    }
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage("Fornecedor atualizado com sucesso!");
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, "Erro ao tentar atualizar o Fornecedor.");
            return null;
        }
    }
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addErrorMessage(e, "Erro ao tentar deletar o Fornecedor.");
        }
    }
    ...
    public static class FornecedorControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Fornecedor) {
                ...
                return getStringKey(o.getCodfornecedor());
            } else {
