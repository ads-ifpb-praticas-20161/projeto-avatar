...
import com.mycompany.contrloedeestoque.facade.EntradaFacade;
...
public class EntradaController implements Serializable {
    ...
    @EJB
    private EntradaFacade ejbFacade;
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage("Entrada criada com sucesso!");
            return prepareCreate();
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, "Erro ao tentar criar Entrada.");
            return null;
        }
    }
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage("Entrada atualizada com sucesso!");
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e,"Erro ao tentar atualizar Entrada.");
            return null;
        }
    }
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage("Entrada removida com sucesso!");
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, "Erro ao tentar remover Entrada.");
        }
    }
    ...
    public static class EntradaControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Entrada) {
                ...
                return getStringKey(o.getCodentrada());
            } else {
