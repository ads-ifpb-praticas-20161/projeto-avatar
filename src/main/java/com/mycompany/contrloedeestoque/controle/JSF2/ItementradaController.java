...
import com.mycompany.contrloedeestoque.facade.ItementradaFacade;
...
public class ItementradaController implements Serializable {
    ...
    @EJB
    private ItementradaFacade ejbFacade;
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage("Item de Entrada criado com sucesso!");
            return prepareCreate();
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, "Erro ao tentar persistir Item de Entrada.");
            return null;
        }
    }
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage("Item de Entrada atualizado com sucesso!");
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, "Erro ao tentar atualizar Item de Entrada.");
            return null;
        }
    }
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage("Item de Entrada removido com sucesso!");
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, "Erro ao tentar remover Item de Entrada.");
        }
    }
    ...
    public static class ItementradaControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Itementrada) {
                ...
                return getStringKey(o.getCoditementrada());
            } else {
