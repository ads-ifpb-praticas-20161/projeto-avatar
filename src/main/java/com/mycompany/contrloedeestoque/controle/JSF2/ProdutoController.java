...
import com.mycompany.contrloedeestoque.facade.ProdutoFacade;
...
public class ProdutoController implements Serializable {
    ...
    public String create() {
        try {
            ...
            JsfUtil.addErrorMessage(e,"Erro ao tentar persistir o Produto.");
            return null;
        }
    }
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage("Produto atualizado com êxito");
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e,"Erro ao tentar atualizar o Produto");
            return null;
        }
    }
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage("Produto deletado com sucesso!");
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e,"Erro ao tentar remover o Produto");
        }
    }
    ...
    public static class ProdutoControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Produto) {
                ...
                return getStringKey(o.getCodproduto());
            } else {
